...
Solving this problem matters for three reasons. First, it gives a low-cost and reproducible platform for
studying decentralized vehicular networking in a college project environment. Second, it provides practical
evidence of infrastructure-free dissemination behavior for scenarios where fixed communication support may be
sparse or temporarily unavailable \cite{lora_mesh_emergency,lora_reliable_v2v_2025}. Third, it shows an
engineering pathway where the same network-layer logic can be tested in simulation and then used in embedded
deployment, which helps build confidence in the protocol behavior before scaling to larger real-world setups.
