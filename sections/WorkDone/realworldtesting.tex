...
and the hop-count field was confirmed to decrement correctly at each hop. So this shows that the mesh routing
...
(approximately $4.3\times$) matches the intended fourfold priority scaling in the delay formula. So this shows
...
the intended emergent behavior from the signal-quality-weighted delay formula. So this shows distributed
