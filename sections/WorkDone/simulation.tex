...
forwarding pipeline at each node stayed unchanged. Because of that, the traces can be read as direct evidence
...
This indicates the simulation can represent both nominal and stressed channel conditions in an interpretable
way.
...
snapshots, while changing the seed produced controlled stochastic differences. Together, this supports the
claim that the framework supports deterministic regression testing and controlled variability analysis within
one methodology.
...
Overall, the simulation campaign gives coherent evidence of logical correctness, timing consistency, and
