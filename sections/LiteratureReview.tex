...
A lot of V2X work shows that many practical architectures depend on infrastructure
...
This is relevant when infrastructure is sparse, temporarily unavailable, or just outside a project-scale budget.
...
unrestricted flooding \cite{routing_mesh_2020,vdtn_routing_eval}. So, the literature generally
